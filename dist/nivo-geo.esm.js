...
import { geoAlbersUsa, geoAzimuthalEqualArea, geoAzimuthalEquidistant, geoGnomonic, geoOrthographic, geoStereographic, geoEqualEarth, geoEquirectangular, geoMercator, geoTransverseMercator, geoNaturalEarth1, geoPath, geoGraticule, geoContains } from 'd3-geo';
...
var useChoropleth = function useChoropleth(_ref2) {
  ...
  var boundFeatures = useMemo(function () {
    return features.map(function (feature) {
      ...
      if (datum) {
        var featureWithData = _objectSpread(_objectSpread({}, feature), {}, {
          data: datum,
          value: datumValue,
...
var ChoroplethPropTypes = _objectSpread$1(_objectSpread$1({}, GeoMapPropTypes), commonChoroplethPropTypes);
var ChoroplethCanvasPropTypes = _objectSpread$1(_objectSpread$1({}, GeoMapCanvasPropTypes), commonChoroplethPropTypes);
...
var GeoMapCanvasDefaultProps = _objectSpread$1(_objectSpread$1({}, commonDefaultProps), {}, {
...
var ChoroplethDefaultProps = _objectSpread$1(_objectSpread$1({}, GeoMapDefaultProps), commonChoroplethDefaultProps);
var ChoroplethCanvasDefaultProps = _objectSpread$1(_objectSpread$1({}, GeoMapCanvasDefaultProps), commonChoroplethDefaultProps);
    ...
    layers.forEach(function (layer) {
      if (layer === 'graticule') {
        ...
        legends.forEach(function (legend) {
          renderLegendToCanvas(ctx, _objectSpread$2(_objectSpread$2({}, legend), {}, {
            data: legendData,
            containerWidth: width,
            containerHeight: height,
            theme: theme
